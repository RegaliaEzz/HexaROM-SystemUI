...
.method protected onPasswordChecked(ZIZ)V
    ...
    .line 193
    iget-object v3, p0, Lcom/android/keyguard/securityview/KeyguardFMMView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    const/4 v4, 0x0

    invoke-virtual {v3, v6, v4}, Lcom/android/internal/widget/LockPatternUtils;->saveRemoteLockPassword(ILjava/lang/String;)V

    .line 195
    new-instance v2, Landroid/content/Intent;

    const-string v3, "com.samsung.Keyguard.UNLOCK_FMM_ALERT"
    ...
    const-string v4, "send Broadcast (UNLOCK_FMM_ALERT_ACTION)"

    invoke-static {v3, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 200
    iget-object v3, p0, Lcom/android/keyguard/securityview/KeyguardFMMView;->mCallback:Lcom/android/keyguard/KeyguardSecurityCallback;

    invoke-interface {v3, v5, v6}, Lcom/android/keyguard/KeyguardSecurityCallback;->reportUnlockAttempt(ZI)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0, v5}, Lcom/android/keyguard/securityview/KeyguardFMMView;->resetPasswordText(Z)V
    ...
    .line 212
    iget-object v3, p0, Lcom/android/keyguard/securityview/KeyguardFMMView;->mSecurityMessageDisplay:Lcom/android/keyguard/KeyguardMessageArea;

    invoke-virtual {p0}, Lcom/android/keyguard/securityview/KeyguardFMMView;->getWrongPasswordStringId()I

    move-result v4

    invoke-virtual {v3, v4, v5}, Lcom/android/keyguard/KeyguardMessageArea;->setMessage(IZ)V
