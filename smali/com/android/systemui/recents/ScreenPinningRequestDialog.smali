...
.method public showPrompt(Ljava/lang/String;Z)V
    ...
    iget-object v8, p0, Lcom/android/systemui/recents/ScreenPinningRequestDialog;->mContext:Landroid/content/Context;
    ...
    sget-boolean v8, Lcom/android/systemui/recents/Constants$Features;->DEVICE_TYPE_TABLET:Z

    if-eqz v8, :cond_1

    iget-boolean v8, p0, Lcom/android/systemui/recents/ScreenPinningRequestDialog;->DEVICE_TYPE_WIFI_ONLY:Z
    ...
    .line 73
    iget-object v8, p0, Lcom/android/systemui/recents/ScreenPinningRequestDialog;->mAccessibilityService:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-direct {v1, v8, v6}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V
    ...
    sput-object v8, Lcom/android/systemui/recents/ScreenPinningRequestDialog;->mDialog:Landroid/app/AlertDialog;

    .line 96
    sget-object v8, Lcom/android/systemui/recents/ScreenPinningRequestDialog;->mDialog:Landroid/app/AlertDialog;
    ...
    .line 100
    const-string v8, "Recents_ScreenPinningRequestDialog"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "showPrompt isExcluded : "
    ...
    .end local v2    # "description_1":Ljava/lang/String;
    ...
    .line 65
    .restart local v2    # "description_1":Ljava/lang/String;
